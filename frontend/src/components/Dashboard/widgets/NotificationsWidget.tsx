...
const NotificationsWidget: React.FC<BaseWidgetProps> = ({ 
  ...
  const loadNotifications = async () => {
    try {
      ...
      // Buscar notificações usando o apiService
      const notificationsResponse = await apiService.getNotifications()
      
      // Mapear notificações para o formato esperado pelo componente
      const mappedNotifications: Notification[] = notificationsResponse.map((notification: any) => ({
        id: notification.id,
