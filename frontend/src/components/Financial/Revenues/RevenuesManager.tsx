                      ...
                      <label className="flex items-center space-x-3 p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                        <input
                          ...
                          onChange={(e) => setFormData(prev => ({ 
                            ...prev, 
                            recurrence: { ...prev.recurrence, isRecurrent: e.target.checked }
                          }))}
                      ...
                      <div className="md:col-span-2">
                        <FinancialRecurrenceConfig
                          ...
                          onToggle={(enabled) => setFormData(prev => ({ 
                            ...prev, 
                            recurrence: { ...prev.recurrence, isRecurrent: enabled }
                          }))}
                        />
                      </div>
                    )}
                    ...
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span className="ml-2">{formData.recurrence.isRecurrent ? 'Sim' : 'Não'}</span>
                        </div>
                      </div>
