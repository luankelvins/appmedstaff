...
import { ContactAnalytics, TeamContactAnalytics } from '../../utils/contactAnalyticsService';
...
const ContactAnalyticsDashboard: React.FC<ContactAnalyticsDashboardProps> = ({
  ...
  useEffect(() => {
    const loadAnalytics = async () => {
      setLoading(true);
      try {
        const { contactAnalyticsService } = await import('../../utils/contactAnalyticsService');
