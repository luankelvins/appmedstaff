...
import { employeeDataService, EmployeeAdministrative } from '../../utils/employeeDataService'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {/* Employees Section */}
        {activeSection === 'employees' && permissions.hasPermission('rbac.user.manage' as PermissionSlug) && !sectionLoading.employees && (
          <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
        ...
        {/* Departments Section */}
        {activeSection === 'departments' && permissions.hasPermission('rbac.user.manage' as PermissionSlug) && !sectionLoading.departments && (
          <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
        ...
        {activeSection === 'employee-form' && permissions.hasPermission('rbac.user.manage' as PermissionSlug) && !sectionLoading['employee-form'] && (
          <div className="p-6">
        ...
        {activeSection === 'department-form' && permissions.hasPermission('rbac.user.manage' as PermissionSlug) && !sectionLoading['department-form'] && (
          <div className="p-6">
            <div className="flex items-center mb-6">
              <Button
                onClick={() => setActiveSection('departments')}
        ...
        {activeSection === 'time-validation' && permissions.hasPermission('hr.attendance.read' as PermissionSlug) && !sectionLoading['time-validation'] && (
          <div className="p-6">
